...
import { putProduct } from '../../redux/asyncActions/product/putProduct'
import { cleanEditStatus } from '../../redux/features/product/productSlice'
...
export const ProductEditForm = ({ renderControl, setRenderControl }) => {
    ...
    const images = renderControl.shelterEditProductInfo.img
